...
// Script to install RedData in your game's directory.
// 
...
const GAME_PLUGIN_PATH = `${RED4EXT_PATH}\\RedData`;
const GAME_SCRIPT_PATH = `${REDSCRIPT_PATH}\\RedData`;
const GAME_TEST_SCRIPT_PATH = `${REDSCRIPT_PATH}\\RedTest`;

const GAME_STORAGE_PATH = `${RED4EXT_PATH}\\RedData\\storages\\Test\\`;
...
const BUILD_LIBRARY_PATH = `build\\Debug\\RedData.dll`;
const GAME_LIBRARY_PATH = `${GAME_PLUGIN_PATH}\\RedData.dll`;
